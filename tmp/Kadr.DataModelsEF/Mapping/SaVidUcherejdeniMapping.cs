...
namespace Domain.Mapping
{
    ...
    /// <summary>
    /// Class mapping to SA_VID_UCHEREJDENI table
    /// </summary>
    public class SaVidUcherejdeniMapping : EntityTypeConfiguration<SaVidUcherejdeni>
    {

        /// <summary>
        /// Constructor
        /// </summary>
        public SaVidUcherejdeniMapping()
        {
            //table
ToTable("SA_VID_UCHEREJDENI");
            // Properties
            //  Id is primary key
