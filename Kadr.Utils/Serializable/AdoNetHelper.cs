...
namespace Apteka.Utils.DataBase
{
    ...
    public class AdoNetHelper
    {
        ...
        private static BitVector32 GetDataSetFlags(DataSet dataSet)
        {
            ...
            flags[DataSetHasNamespace] = dataSet.Namespace?.Length != 0;
            flags[DataSetHasPrefix] = dataSet.Prefix?.Length != 0;
        ...
        private static BitVector32 GetTableFlags(DataTable dataTable)
        {
            ...
            flags[TableHasName] = dataTable.TableName?.Length != 0;
            ...
            flags[TableHasDisplayExpression] = dataTable.DisplayExpression?.Length != 0;
            ...
            flags[TableHasNamespace] = dataTable.Namespace?.Length != 0;
            flags[TableHasPrefix] = dataTable.Prefix?.Length != 0;
        ...
        private static BitVector32 GetColumnFlags(DataColumn dataColumn)
        {
            ...
            flags[ColumnHasAutoIncrement] = false;
            flags[ColumnHasAutoIncrementUnusedDefaults] = false;
            flags[ColumnHasAutoIncrementNegativeStep] = false;

            flags[ColumnHasDefaultValue] = dataColumn.DefaultValue != DBNull.Value;
            flags[ColumnHasExpression] = dataColumn.Expression?.Length != 0;
            flags[ColumnIsReadOnly] = dataColumn.ReadOnly;
            flags[ColumnHasExtendedProperties] = dataColumn.ExtendedProperties.Count != 0;

            flags[ColumnHasPrefix] = dataColumn.Prefix?.Length != 0;
        ...
        private static BitVector32 GetUniqueConstraintFlags(UniqueConstraint uniqueConstraint)
        {
            ...
            flags[UniqueConstraintHasSchemaName] = ((string)ConstraintSchemaNameFieldInfo.GetValue(uniqueConstraint))?.Length != 0;
        ...
        private static BitVector32 GetForeignKeyConstraintFlags(ForeignKeyConstraint foreignKeyConstraint)
        {
            ...
            flags[ForeignKeyConstraintHasSchemaName] = ((string)ConstraintSchemaNameFieldInfo.GetValue(foreignKeyConstraint))?.Length != 0;
        ...
        private static BitVector32 GetRelationFlags(DataRelation relation)
        {
            ...
            flags[RelationHasDefaultName] = relation.RelationName?.Length != 0;
        ...
        private class FastDeserializer
        {
            ...
            private void deserializeRows(DataTable dataTable)
            {
                ...
                for (int i = 0; i < rowCount; i++)
                {
                    ...
                    else
                    {
                        ...
                        reader.ReadOptimizedObjectArrayPair(out object[] currentValues, out object[] originalValues);
            ...
            private void deserializeUniqueConstraints(DataTable dataTable)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    {
                        constraintName = "Constraint" + reader.ReadOptimizedInt32().ToString();
                    }
            ...
            private void deserializeColumns(DataTable dataTable)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    {
                        AllowDBNull = flags[ColumnIsNullable],

                        AutoIncrement = flags[ColumnHasAutoIncrement]
                    };
