...
namespace Apteka.Utils
{
    public class CCRC32 : HashAlgorithm
    {
        ...
        private CCRC32(UInt32 polynomial, UInt32 seed)
        {
        ...
        private static UInt32 Compute(UInt32 seed, byte[] buffer)
        {
            return ~CalculateHash(InitializeTable(DefaultPolynomial), seed, buffer, 0, buffer.Length);
        }

        private static UInt32 Compute(UInt32 polynomial, UInt32 seed, byte[] buffer)
        {
