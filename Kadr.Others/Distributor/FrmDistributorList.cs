...
{
    public partial class FrmDistributorList : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public FrmDistributorList()
        {
            ...
            gridControl.DataSource = db.Distributor.GetAll().ToList();
        ...
        private void ShowForm(bool IsNew)
        {
            ...
            if (IsNew)
            {
                f = new FrmNewDistributor();
            }
            else
            {
                index = gridView1.FocusedRowHandle;
                var row = gridView1.GetFocusedRow() as spDistributor;
                f = new FrmNewDistributor(row);
            }
        ...
        private void btnDel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var row = gridView1.GetFocusedRow() as spDistributor;
            var it = db.Distributor.Get(row.Id);
