...
{
    public partial class FrmUnitsList : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public FrmUnitsList()
        {
            ...
            gridControl.DataSource = db.Unit.GetAll().ToList();
        ...
        private void ShowForm(bool IsNew)
        {
            ...
            if (!IsNew)
            {
                ...
                row = gridView1.GetFocusedRow() as spUnit;
        ...
        private void btnDel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var row = gridView1.GetFocusedRow() as spUnit;
            var it = db.Unit.Get(row.Id);
            it.Send = 0;
