...
{
    public partial class FrmPharmGroupsList : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        private IUnitOfWork db;
        public ReportGridForms ReportConfig { get; private set; }

        public FrmPharmGroupsList()
        {
            InitializeComponent();
            ...
            gridControl.DataSource = db.PharmGroup.GetAll().ToList();
        ...
        private void ShowForm(bool IsNew)
        {
            ...
            if (!IsNew)
            {
                ...
                row = gridView1.GetFocusedRow() as spPharmGroup;
            ...
            if (f.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    var d = db.PharmGroup.Get(row.Id);
                    d.Name = f.edName.Text;
                    d.Status = 1;
        ...
        private void btnDel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var row = gridView1.GetFocusedRow() as spPharmGroup;
            var it = db.PharmGroup.Get(row.Id);
            it.Send = 0;
